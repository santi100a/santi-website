...
const chistes = Object.freeze([
    ...
    '+Puff... me ha caído mal el estofado\n-¡Pues no le hables!',
...
const pantalla = Object.freeze(document.querySelector('div#pantalla'));

// @ts-ignore
pantalla.innerText = 
chistes[random(chistes.length)];
